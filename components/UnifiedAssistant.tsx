  ...
  if (variant === 'floating') {
    return (
      <>
        ...
        {/* Assistant Window */}
        {isOpen && (
          <div className={`fixed bottom-6 right-6 w-96 bg-white rounded-xl shadow-2xl border border-[#E5E7EB] z-50 flex flex-col ${isMinimized ? 'h-16' : 'h-[600px]'} transition-all duration-300`}>
            ...
            <div className="bg-gradient-to-r from-[#0B1B2B] to-[#0B1B2B]/90 text-white p-4 rounded-t-xl flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-[#C9A24A] rounded-full flex items-center justify-center">
                  {mode === 'voice' ? <Mic className="w-5 h-5 text-white" /> : <Bot className="w-5 h-5 text-white" />}
                </div>
                <div>
                  <h3 className="font-semibold text-white text-base leading-tight">
                    {mode === 'voice' ? 'Ask Relo - Voice' : 'Ask Relo - Text'}
                  </h3>
                      ...
                      <div className="h-full flex items-center justify-center p-4">
                        {callStatus === 'idle' && (
                          <div className="text-center space-y-4">
                            ...
                            <h3 className="text-lg font-bold text-[#0B1B2B]">Voice Chat with Relo</h3>
                            <p className="text-[#6B7280] text-sm">
                              Start a natural conversation about your London relocation
                            </p>
