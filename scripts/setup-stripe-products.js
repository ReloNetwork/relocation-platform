...
async function createProduct() {
  try {
    ...
    const product = await stripe.products.create({
      ...
      description: 'Area fit analysis, property shortlist, viewings route, tenancy rider review',
      metadata: {
        service_type: 'audit',
    ...
    const price = await stripe.prices.create({
      ...
      metadata: {
        ...
        includes: 'Area analysis, property shortlist, viewing route, tenancy rider review, 60-min strategy call'
      }
    });
