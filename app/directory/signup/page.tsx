...
export default function DirectorySignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Error submitting signup. Please try again or call +44 20 3105 9566')
    } finally {
      setLoading(false)
    }
  }
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-[#E5E7EB]">
            ...
            <div className="text-center mt-6">
              <p className="text-sm text-[#6B7280]">
                Questions? Call our directory team: <span className="font-semibold text-[#0B1220]">+44 20 3105 9566</span>
              </p>
            </div>
          </div>
