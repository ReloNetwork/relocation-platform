  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('Redirecting to payment options:', `/corporate/payment-clean?${params.toString()}`)
        
        // Use window.location for more reliable redirect
        window.location.href = `/corporate/payment-clean?${params.toString()}`
      } else {
