...
const PRODUCTS: Record<string, ProductConfig> = {
  'lead-machine': {
    ...
    description:
      'Premium lead generation partnership with 8-15 guaranteed qualified leads monthly',
    amount: 49700, // £497.00
    interval: 'month',
    features: [
  ...
  'lead-machine-annual': {
    ...
    description:
      'Premium lead generation partnership - Annual plan with 10 months at founding rate + 2 months FREE',
  ...
  'market-dominator': {
    ...
    description:
      'Ultimate partnership with exclusive category ownership and maximum ROI potential',
  ...
  'market-dominator-annual': {
    ...
    description:
      'Ultimate partnership with exclusive category ownership - Annual plan with 10 months at founding rate + 2 months FREE',
  ...
  'premium-directory': {
    ...
    description:
      'Access to 500+ verified service providers with direct messaging capabilities',
    amount: 4700, // £47.00
    interval: 'month',
    features: [
  ...
  'premium-directory-annual': {
    ...
    description:
      'Access to 500+ verified service providers - Annual plan with 2 months FREE',
  ...
  'vip-concierge': {
    ...
    description:
      'Ultimate solution for enterprise clients with personal account manager',
    amount: 14700, // £147.00
    interval: 'month',
    features: [
  ...
  'vip-concierge-annual': {
    ...
    description:
      'Ultimate solution for enterprise clients - Annual plan with 2 months FREE',
...
export async function POST(request: NextRequest) {
  try {
    ...
    const stripeProduct = await stripe.products.create({
      ...
      images: [
        'https://relocation-platform.vercel.app/images/relo-logo-square.png',
      ],
...
function getCustomMessage(productKey: string): string {
  const messages = {
    'lead-machine':
      'Join the Lead Machine Partnership and start receiving 8-15 qualified leads within 24-48 hours.',
    'lead-machine-annual':
      'Lock in the Lead Machine founding rate for a full year and save £996 compared to monthly billing.',
    'market-dominator':
      'Secure your Market Dominator status with exclusive category ownership and eliminate all competition.',
    'market-dominator-annual':
      'Lock in the Market Dominator founding rate for a full year and save £2,994 compared to monthly billing.',
    'premium-directory':
      'Access our premium directory of 500+ verified service providers with direct messaging capabilities.',
    'premium-directory-annual':
      'Get Premium Directory access for a full year and save £94 with annual billing.',
    'vip-concierge':
      'Unlock VIP access with your personal account manager and 24/7 concierge support.',
    'vip-concierge-annual':
      'Get VIP Concierge service for a full year and save £294 with annual billing.',
  };

  return (
    messages[productKey as keyof typeof messages] ||
