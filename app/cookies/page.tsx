...
export default function CookiesPage() {
  return <LegalDocument eyebrow="COOKIES" title="We keep tracking to a minimum." summary="The public website does not use advertising cookies or Google Analytics. This page explains the small amount of browser storage and measurement we use." updated="27 August 2026" sections={[
    ...
    { title: 'Strictly necessary storage', bullets: ['Authentication cookies may be used when an authorised client or administrator signs in.', 'Ask Relo stores a random session identifier in local storage so the browser can apply the three-question limit. It does not store the question text there.', 'Short-lived session storage may carry a submitted reference or form state to a confirmation page.', 'Security and deployment systems may use essential technical data needed to deliver and protect the site.'] },
    { title: 'No advertising profiles', paragraphs: ['We do not use advertising pixels or sell browsing data. If we add optional cookies, advertising pixels or similar tracking later, we will update this notice and ask for consent where required before switching them on.'] },
