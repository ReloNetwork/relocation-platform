              ...
              >
                ...
                <CardContent className="space-y-2">
                  <div className="relative bg-gradient-to-br from-[#0B1B2B] to-[#1F2937] rounded-lg overflow-hidden aspect-video">
                    <video 
                      src="/videos/London Relocation Solved.mp4" 
                      className="w-full h-full object-cover"
                      controls
                      preload="metadata"
                      poster="/assets/proof-testimonial.jpg"
                      style={{
                        filter: 'blur(0px) contrast(1.1) brightness(0.95)',
                        objectPosition: 'center top'
                      }}
                    >
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-[#C9A24A] font-medium mt-1">▶ Client testimonial video (45s)</div>
                  </div>
                </CardContent>
              </Card>
            </div>
